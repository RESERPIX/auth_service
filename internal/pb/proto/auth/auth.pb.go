...
type LoginResponse struct {
	...
	ExpiresIn     uint64                 `protobuf:"varint,2,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"` // опционально добавишь на сервере
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginResponse) GetExpiresIn() uint64 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"expires_in\x18\x02 \x01(\x04R\texpiresIn2z\n" +
	"\vAuthService\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB/Z-github.com/RESERPIX/auth_service/internal/pb/b\x06proto3"
